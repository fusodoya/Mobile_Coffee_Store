...
public class RedeemAdapter extends RecyclerView.Adapter<RedeemAdapter.CoffeeViewHolder> {
    ...
    public RedeemAdapter(Context context, OnRedeemClickListener listener) {
